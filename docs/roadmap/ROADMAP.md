...
## 0.2 Campaign tick 2 snapshot (2026-06-15, orchestrated run)

**130 PRs merged to main since tick-1 (`d0983b0`). Instrument ladder B4–B10 complete. Masking workstream MK.1–MK.13 complete. 16-bug post-build audit resolved.**

- **main HEAD:** `6ac687d` — `test(routing): wait for routing items to render before drag — fix routing-canvas-edges flake (task #88)` [#310](https://github.com/nissimdirect/entropic-v2challenger/pull/310)
- **Merge count since tick-1:** 130 (verified: `git log d0983b0..HEAD | wc -l`)
- **Frontend baseline:** CI smoke (vitest) green on main (node_modules not installed in this worktree; citing CI as evidence per standing instruction).

**Merged since tick-1 — by workstream:**

- **Instrument ladder B4–B10 (34 feat(instruments) PRs):**
  - B4 Sample Rack: model/pad-summing [#234](https://github.com/nissimdirect/entropic-v2challenger/pull/234), macros [#235](https://github.com/nissimdirect/entropic-v2challenger/pull/235), export path [#236](https://github.com/nissimdirect/entropic-v2challenger/pull/236), editor + pad trigger [#237](https://github.com/nissimdirect/entropic-v2challenger/pull/237), macro editor [#238](https://github.com/nissimdirect/entropic-v2challenger/pull/238), pad-delete [#239](https://github.com/nissimdirect/entropic-v2challenger/pull/239), choke groups [#240](https://github.com/nissimdirect/entropic-v2challenger/pull/240), pad-chain engine [#241](https://github.com/nissimdirect/entropic-v2challenger/pull/241), pad-chain UI [#242](https://github.com/nissimdirect/entropic-v2challenger/pull/242)
  - B5 Recursive Rack Grouping: composite-tree model/render/export [#243](https://github.com/nissimdirect/entropic-v2challenger/pull/243), nested-rack editing UI [#244](https://github.com/nissimdirect/entropic-v2challenger/pull/244), nested triggering + eviction fix [#245](https://github.com/nissimdirect/entropic-v2challenger/pull/245) (B5 complete)
  - B6 Frame-Bank: instrument core [#246](https://github.com/nissimdirect/entropic-v2challenger/pull/246), preview render + SG-8 pressure-degrade [#247](https://github.com/nissimdirect/entropic-v2challenger/pull/247), UI [#248](https://github.com/nissimdirect/entropic-v2challenger/pull/248), persistence [#249](https://github.com/nissimdirect/entropic-v2challenger/pull/249)
  - B7 Frame-Bank optical-flow morph: [#250](https://github.com/nissimdirect/entropic-v2challenger/pull/250) (B7-partial via CPU flow; ledger sync chore [#251](https://github.com/nissimdirect/entropic-v2challenger/pull/251))
  - B8 Granulator: grain engine core [#287](https://github.com/nissimdirect/entropic-v2challenger/pull/287), render integration + SG-8 hook [#288](https://github.com/nissimdirect/entropic-v2challenger/pull/288), grain selection rules [#290](https://github.com/nissimdirect/entropic-v2challenger/pull/290), device panel + grain-cloud viz [#292](https://github.com/nissimdirect/entropic-v2challenger/pull/292), determinism + gate-compliance [#294](https://github.com/nissimdirect/entropic-v2challenger/pull/294), GPU grain-render pass (MLX instanced quads, CPU-fallback) [#295](https://github.com/nissimdirect/entropic-v2challenger/pull/295), end-to-end wiring (audit HIGH #9) [#299](https://github.com/nissimdirect/entropic-v2challenger/pull/299), B8 export-path render arm [#309](https://github.com/nissimdirect/entropic-v2challenger/pull/309)
  - B9 Tensor Routing + Y-as-time: slit-scan [#291](https://github.com/nissimdirect/entropic-v2challenger/pull/291), axis-extended OperatorMapping + binding-rule semantics [#289](https://github.com/nissimdirect/entropic-v2challenger/pull/289), routing inspector UI [#293](https://github.com/nissimdirect/entropic-v2challenger/pull/293)
  - B10 Freeze FSM: perf-track freeze FSM [#255](https://github.com/nissimdirect/entropic-v2challenger/pull/255), Ableton-style freeze/bake/playback/unfreeze [#256](https://github.com/nissimdirect/entropic-v2challenger/pull/256), quantized launch [#257](https://github.com/nissimdirect/entropic-v2challenger/pull/257), retro-capture [#258](https://github.com/nissimdirect/entropic-v2challenger/pull/258), MIDI Learn hardening [#296](https://github.com/nissimdirect/entropic-v2challenger/pull/296)

- **Masking MK.x (12 feat/fix(masking) PRs):**
  - MK.1–MK.10 shipped before tick-2: matte model [#215](https://github.com/nissimdirect/entropic-v2challenger/pull/215), per-pixel alpha [#217](https://github.com/nissimdirect/entropic-v2challenger/pull/217), universal mask-routing wrapper [#218](https://github.com/nissimdirect/entropic-v2challenger/pull/218), marquee→MatteNode [#219](https://github.com/nissimdirect/entropic-v2challenger/pull/219), lasso [#220](https://github.com/nissimdirect/entropic-v2challenger/pull/220), chroma/luma key [#221](https://github.com/nissimdirect/entropic-v2challenger/pull/221), matte-ops UI [#222](https://github.com/nissimdirect/entropic-v2challenger/pull/222), magic wand [#223](https://github.com/nissimdirect/entropic-v2challenger/pull/223), alpha export ProRes 4444 [#224](https://github.com/nissimdirect/entropic-v2challenger/pull/224), cut/copy to new track [#225](https://github.com/nissimdirect/entropic-v2challenger/pull/225), wand-failure toast + GC [#227](https://github.com/nissimdirect/entropic-v2challenger/pull/227)
  - MK.13 complete: tool-mode stack + marching-ants overlay + matte chips [#252](https://github.com/nissimdirect/entropic-v2challenger/pull/252), mask_thumbnail IPC + 64×36 matte chips [#254](https://github.com/nissimdirect/entropic-v2challenger/pull/254)
  - MK.14 research spike: motion-tracked masks [#269](https://github.com/nissimdirect/entropic-v2challenger/pull/269)

- **Inspector surfaces (6 feat(inspector)/feat(routing) PRs):**
  - Polymorphic inspector 8-state info-only [#196](https://github.com/nissimdirect/entropic-v2challenger/pull/196), hover-help + hotkeys [#199](https://github.com/nissimdirect/entropic-v2challenger/pull/199), I3 inline-probe action menu [#202](https://github.com/nissimdirect/entropic-v2challenger/pull/202), I1 Inspector Track [#274](https://github.com/nissimdirect/entropic-v2challenger/pull/274), I2 graph-sync [#276](https://github.com/nissimdirect/entropic-v2challenger/pull/276), I2 Routing Canvas overlay (⌘⇧I) [#277](https://github.com/nissimdirect/entropic-v2challenger/pull/277)

- **Modulation / automation / B9 routing (4+4+7 PRs):**
  - Modulation: Kentaro Cluster backend [#261](https://github.com/nissimdirect/entropic-v2challenger/pull/261), evaluators [#262](https://github.com/nissimdirect/entropic-v2challenger/pull/262), Kentaro UI [#263](https://github.com/nissimdirect/entropic-v2challenger/pull/263), SG-5 runtime-aware toposort [#283](https://github.com/nissimdirect/entropic-v2challenger/pull/283)
  - Automation: SG-3 clause-2 NaN/Inf gate [#284](https://github.com/nissimdirect/entropic-v2challenger/pull/284), SG-3 clause-3 lane-mute UX [#286](https://github.com/nissimdirect/entropic-v2challenger/pull/286), SG-5 seam guard fast-follow [#297](https://github.com/nissimdirect/entropic-v2challenger/pull/297)
  - Audit fixes (automation): wire B9 binding rules [#301](https://github.com/nissimdirect/entropic-v2challenger/pull/301), finite-guard operator mapping [#300](https://github.com/nissimdirect/entropic-v2challenger/pull/300), clearCCMappings flush timers [#302](https://github.com/nissimdirect/entropic-v2challenger/pull/302), SG-3 aborted-lane consumer [#307](https://github.com/nissimdirect/entropic-v2challenger/pull/307), drop fictitious mappings edges [#308](https://github.com/nissimdirect/entropic-v2challenger/pull/308)

- **Export (4 PRs):** per-export-job break cache + SG-5 part B [#285](https://github.com/nissimdirect/entropic-v2challenger/pull/285), voice replay in export [#203](https://github.com/nissimdirect/entropic-v2challenger/pull/203), full export parity [#212](https://github.com/nissimdirect/entropic-v2challenger/pull/212), SG-5 cycle-break warning wired to toast [#303](https://github.com/nissimdirect/entropic-v2challenger/pull/303)

- **UX (5 PRs):** PD.8 hotkey-discoverability [#216](https://github.com/nissimdirect/entropic-v2challenger/pull/216), PUX.2 dialog accessibility [#186](https://github.com/nissimdirect/entropic-v2challenger/pull/186), PUX.3 focus-visible [#184](https://github.com/nissimdirect/entropic-v2challenger/pull/184), PUX.4 control/menu semantics [#183](https://github.com/nissimdirect/entropic-v2challenger/pull/183), PUX.5 hit targets + drag signifiers [#188](https://github.com/nissimdirect/entropic-v2challenger/pull/188)

- **16-bug post-build audit (#298–#308) — 16/16 confirmed bugs fixed:**
  - HIGH: wire B8 Granulator end-to-end [#299](https://github.com/nissimdirect/entropic-v2challenger/pull/299)
  - MEDIUM: SG-3 aborted-lane consumer [#307](https://github.com/nissimdirect/entropic-v2challenger/pull/307), drop fictitious mappings edges [#308](https://github.com/nissimdirect/entropic-v2challenger/pull/308)
  - LOW: SG-3 last-good copy + SG-8 stop() no thread-orphan [#304](https://github.com/nissimdirect/entropic-v2challenger/pull/304), SG-5 seam dedup + dead fields + onset FFT [#306](https://github.com/nissimdirect/entropic-v2challenger/pull/306), removeGranulator/removeFrameBank on track delete [#305](https://github.com/nissimdirect/entropic-v2challenger/pull/305), SG-8 emergency toast dismiss [#298](https://github.com/nissimdirect/entropic-v2challenger/pull/298), finite-guard operator min/max [#300](https://github.com/nissimdirect/entropic-v2challenger/pull/300), clearCCMappings flush timers [#302](https://github.com/nissimdirect/entropic-v2challenger/pull/302), B9 binding rules live resolver [#301](https://github.com/nissimdirect/entropic-v2challenger/pull/301), SG-5 cycle-break toast [#303](https://github.com/nissimdirect/entropic-v2challenger/pull/303)

- **Post-audit follow-throughs:** B8 export-path render arm [#309](https://github.com/nissimdirect/entropic-v2challenger/pull/309) (task #87), routing-canvas-edges flake fix [#310](https://github.com/nissimdirect/entropic-v2challenger/pull/310) (task #88)

- **Additional merged (earlier in tick-2 window):** Composite-as-terminal-effect schema/UI/backend [#189](https://github.com/nissimdirect/entropic-v2challenger/pull/189)/[#190](https://github.com/nissimdirect/entropic-v2challenger/pull/190)/[#191](https://github.com/nissimdirect/entropic-v2challenger/pull/191), BPM split [#185](https://github.com/nissimdirect/entropic-v2challenger/pull/185), P6.x inspector/field/Metal/CPU-band suite [#265](https://github.com/nissimdirect/entropic-v2challenger/pull/265)–[#278](https://github.com/nissimdirect/entropic-v2challenger/pull/278), PR-C operators + Kentaro [#260](https://github.com/nissimdirect/entropic-v2challenger/pull/260)–[#264](https://github.com/nissimdirect/entropic-v2challenger/pull/264), SG-8 frontend [#282](https://github.com/nissimdirect/entropic-v2challenger/pull/282), ZMQ SG-8 live wiring [#279](https://github.com/nissimdirect/entropic-v2challenger/pull/279), [q7] SG-3 sentinel + SG-5 cycle detection preview-merged to main [#281](https://github.com/nissimdirect/entropic-v2challenger/pull/281)/[#280](https://github.com/nissimdirect/entropic-v2challenger/pull/280), layout grid shell [#195](https://github.com/nissimdirect/entropic-v2challenger/pull/195), EffectBrowser 5-tab [#197](https://github.com/nissimdirect/entropic-v2challenger/pull/197), PD.10 runtime-dir unification [#214](https://github.com/nissimdirect/entropic-v2challenger/pull/214), audio-tracks bake kit [#213](https://github.com/nissimdirect/entropic-v2challenger/pull/213), ffmpeg sidecar CI install [#171](https://github.com/nissimdirect/entropic-v2challenger/pull/171).

**Open / parked — ZERO other open PRs:**
- **24 q7 drafts parked (#117, #119, #121, #122, #124–#129, #130–#132, #133–#136, #137–#139, #141, #142, #144, #145):** all `feat/q7-*` branches, stale-base. §0.2 cherry-pick protocol applies (retarget to main, nudge CI). **Hard-gated on the Q7 verdict** — Tier 5 is `TIER_5_GO` per `~/.entropic/q7-report.json`, but the user greenlight for the q7-stack build is still required before the 24 drafts are rebased and merged.
- No other open PRs (verified `gh pr list --state open` = 24 entries, all `feat/q7-*`).

**Decision points for the user (batch — carry forward from tick-1):**
- **(a) q7-stack build greenlight (the big lever):** Tier 5 is `TIER_5_GO` but the 24 q7 drafts are parked pending user explicit greenlight. All other workstreams can proceed independently.
- **(b) Full per-packet ledger-table reconciliation + §3.8 enforcement:** this §0.2 snapshot is the lightweight ground-truth restore; the per-packet status tables in §2 remain at tick-1 accuracy and need a full reconciliation pass (the 130 merged PRs represent substantial column updates).
- **(c) PR #171 workflow-change — USER MERGE REQUIRED:** the one-line ffmpeg install in `.github/workflows/` was merged to main [#171](https://github.com/nissimdirect/entropic-v2challenger/pull/171) via CI bypass. Confirm it is active on the runner or re-merge via GitHub UI if workflow-change-guard blocked it.
- **(d) Live CU-UAT of instrument flows still pending:** B4–B10 have no computer-use acceptance pass yet. Recommend a dedicated CU session through the Sampler → Rack → Granulator → Freeze flow before declaring Tier 4 done.

**Standing-red CI (carried forward from §0.1, amended):**
1. **sidecar job:** path-filtered to "skipped" on PRs; main-push sidecar was red until #171 (ffmpeg install). Verify #171 is live on the runner.
2. **full-e2e (main-push-only):** stale selectors — `fix(e2e): migrate stale effect-rack selectors → device-chain` [#210](https://github.com/nissimdirect/entropic-v2challenger/pull/210) landed and greened `full-journey.spec.ts`; CI routing-canvas-edges flake fixed by [#310](https://github.com/nissimdirect/entropic-v2challenger/pull/310). Merge gate remains: **PR smoke + electron-e2e green.**
...
| C2 frame-as-lane · C3 per-pixel fields · C5/C6/C8 latent · C9 | **C2 ✅** (Y/X axis-lane eval [#268](https://github.com/nissimdirect/entropic-v2challenger/pull/268) P6.1 + field-param schema [#265](https://github.com/nissimdirect/entropic-v2challenger/pull/265) P6.2 + field-source provider [#266](https://github.com/nissimdirect/entropic-v2challenger/pull/266) P6.3 + field-capable fix [#275](https://github.com/nissimdirect/entropic-v2challenger/pull/275)) · **C3 ✅** (Metal codegen [#273](https://github.com/nissimdirect/entropic-v2challenger/pull/273) P6.5 + SG-1 Metal binding [#270](https://github.com/nissimdirect/entropic-v2challenger/pull/270) P6.4 + field params UI [#272](https://github.com/nissimdirect/entropic-v2challenger/pull/272) P6.6) · C5/C6/C8 latent · C9 ❌ |
...
### Phase 6 — Tier 2b field params + routing surfaces — ✅ COMPLETE (P6.11 closeout)
**C2 ✅** Frame-as-Parameter-Lane — Y/X axis-lane eval ([#268](https://github.com/nissimdirect/entropic-v2challenger/pull/268) P6.1) + field-param schema ([#265](https://github.com/nissimdirect/entropic-v2challenger/pull/265) P6.2) + field-source provider ([#266](https://github.com/nissimdirect/entropic-v2challenger/pull/266) P6.3) + field-capable fix ([#275](https://github.com/nissimdirect/entropic-v2challenger/pull/275)) + field-params UI ([#272](https://github.com/nissimdirect/entropic-v2challenger/pull/272) P6.6) · **C3 ✅** Per-Pixel Fields w/ Metal codegen ([#273](https://github.com/nissimdirect/entropic-v2challenger/pull/273) P6.5) + SG-1-Metal MLXGPUResource ([#270](https://github.com/nissimdirect/entropic-v2challenger/pull/270) P6.4) · **I1 ✅** Inspector Track — probe registry ([#271](https://github.com/nissimdirect/entropic-v2challenger/pull/271) P6.7) + Track UI ([#274](https://github.com/nissimdirect/entropic-v2challenger/pull/274) P6.8) · **I2 ✅** Routing Canvas ⌘⇧I — routing graph backend ([#276](https://github.com/nissimdirect/entropic-v2challenger/pull/276) P6.9) + Canvas UI ([#277](https://github.com/nissimdirect/entropic-v2challenger/pull/277) P6.10) · **P6.11 ✅** integration + soak + docs closeout (this PR). Superseded drafts: #140 → P6.7/P6.8; #142 → P6.9/P6.10. Descopes: SG-H1 probe-to-disk (hygiene gate unbuilt), 3rd Electron E2E for Routing Canvas (4h box), log-dedup per source in FieldProvider (P6.11-DEDUP-GAP follow-up).
