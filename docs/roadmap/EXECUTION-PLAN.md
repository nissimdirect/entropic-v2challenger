...
| **MK.x Masking Phase A** | MK.1–MK.10 + MK.CU: matte model, per-pixel alpha, **universal mask-routing wrapper (MK.3 — HEADLINE)**, marquee/lasso/wand/color-range/key tools, cut-to-track, alpha export, CU journey suite | **`packets/masking.md`** (authored 2026-06-12, full §1 contracts — NOT a stub; 14 packets + CU) | **✅ MERGED — MK.1 #215, MK.2 #217, MK.3 #218, MK.4 #219, MK.5 #220, MK.6 #223+#227, MK.7 #222, MK.8 #221, MK.9 #225, MK.10 #224, MK.13 #252+#254, MK.14 spike #269 — all on origin/main as of 2026-06-16, task #84.** MK.CU J1–J5 ❌ NEVER RUN (corrected 2026-07-02 — the prior “active in rotation” claim here was false; no run artifact exists). It is satisfied by `docs/UAT-PLAN-2026-07-02-live-cu.md` Stage F when executed. Phase B (MK.11/MK.12) pending. |
...
**Merge-gate rider (2026-07-02):** the campaign-era smoke-only merge gate is RETIRED. Standard gate = PR `smoke` + `electron-e2e` green (+ `sidecar` where path-applicable). Rationale: merge-on-smoke let the e2e job rot back red within 48h of being fixed (month-audit finding).
