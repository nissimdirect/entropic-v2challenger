"""Auto-generated oracle for fx.watercolor.
...
@pytest.mark.oracle
def test_watercolor_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """watercolor should produce visible change at default params."""
