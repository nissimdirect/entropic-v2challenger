"""Auto-generated oracle for fx.false_color.
...
@pytest.mark.oracle
def test_false_color_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """false_color should visibly transform flat testsrc input."""
