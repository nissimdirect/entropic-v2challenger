"""Auto-generated oracle for fx.frame_smash.
...
@pytest.mark.oracle
def test_frame_smash_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """frame_smash should rearrange pixels on rich input."""
