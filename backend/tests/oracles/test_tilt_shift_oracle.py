"""Auto-generated oracle for fx.tilt_shift.
...
@pytest.mark.oracle
def test_tilt_shift_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """tilt_shift should alter high-frequency content."""
