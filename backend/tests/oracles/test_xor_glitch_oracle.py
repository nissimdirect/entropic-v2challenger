"""Auto-generated oracle for fx.xor_glitch.
...
@pytest.mark.oracle
def test_xor_glitch_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """xor_glitch should produce visible change at default params."""
