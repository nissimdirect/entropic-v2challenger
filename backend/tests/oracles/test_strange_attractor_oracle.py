"""Auto-generated oracle for fx.strange_attractor.
...
@pytest.mark.oracle
def test_strange_attractor_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """strange_attractor should add visible content to the frame."""
