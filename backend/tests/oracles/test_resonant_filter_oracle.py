"""Auto-generated oracle for fx.resonant_filter.
...
@pytest.mark.oracle
def test_resonant_filter_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """resonant_filter should alter high-frequency content."""
