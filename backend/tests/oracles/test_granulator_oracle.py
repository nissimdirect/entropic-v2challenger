"""Auto-generated oracle for fx.granulator.
...
@pytest.mark.oracle
def test_granulator_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """granulator should produce a detectable first-frame difference."""
