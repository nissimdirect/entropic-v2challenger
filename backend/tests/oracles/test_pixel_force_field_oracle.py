"""Auto-generated oracle for fx.pixel_force_field.
...
@pytest.mark.oracle
def test_pixel_force_field_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_force_field should produce a detectable first-frame difference."""
