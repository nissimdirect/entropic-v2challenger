"""Auto-generated oracle for fx.color_filter.
...
@pytest.mark.oracle
def test_color_filter_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """color_filter should visibly transform flat testsrc input."""
