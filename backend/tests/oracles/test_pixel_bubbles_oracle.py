"""Auto-generated oracle for fx.pixel_bubbles.
...
@pytest.mark.oracle
def test_pixel_bubbles_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """pixel_bubbles should add visible content to the frame."""
