"""Auto-generated oracle for fx.posterize.
...
@pytest.mark.oracle
def test_posterize_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """posterize should visibly transform flat testsrc input."""
