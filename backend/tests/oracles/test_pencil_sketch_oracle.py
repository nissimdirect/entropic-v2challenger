"""Auto-generated oracle for fx.pencil_sketch.
...
@pytest.mark.oracle
def test_pencil_sketch_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """pencil_sketch should produce visible change at default params."""
