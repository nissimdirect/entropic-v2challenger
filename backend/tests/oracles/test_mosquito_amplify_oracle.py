"""Auto-generated oracle for fx.mosquito_amplify.
...
MIN_L1 = 1.0  # composite default barely moves pixels; catches silent-disable (L1=0)


@pytest.mark.oracle
def test_mosquito_amplify_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """mosquito_amplify should produce visible change at default params."""
