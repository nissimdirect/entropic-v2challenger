"""Auto-generated oracle for fx.comb_filter.
...
@pytest.mark.oracle
def test_comb_filter_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """comb_filter should rearrange pixels on rich input."""
