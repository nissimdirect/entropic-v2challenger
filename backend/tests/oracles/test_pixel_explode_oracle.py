"""Auto-generated oracle for fx.pixel_explode.
...
@pytest.mark.oracle
def test_pixel_explode_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_explode should produce a detectable first-frame difference."""
