"""Auto-generated oracle for fx.temporal_blend.
...
@pytest.mark.oracle
def test_temporal_blend_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """temporal_blend should produce a detectable first-frame difference."""
