"""Auto-generated oracle for fx.wavefold.
...
@pytest.mark.oracle
def test_wavefold_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """wavefold should visibly transform flat testsrc input."""
