"""Auto-generated oracle for fx.bitcrush.
...
@pytest.mark.oracle
def test_bitcrush_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """bitcrush should visibly transform flat testsrc input."""
