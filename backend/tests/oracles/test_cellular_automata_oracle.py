"""Auto-generated oracle for fx.cellular_automata.
...
@pytest.mark.oracle
def test_cellular_automata_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """cellular_automata should add visible content to the frame."""
