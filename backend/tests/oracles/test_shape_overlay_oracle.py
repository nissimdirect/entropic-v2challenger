"""Auto-generated oracle for fx.shape_overlay.
...
@pytest.mark.oracle
def test_shape_overlay_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """shape_overlay should add visible content to the frame."""
