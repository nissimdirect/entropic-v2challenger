"""Auto-generated oracle for fx.wave_distort.
...
@pytest.mark.oracle
def test_wave_distort_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """wave_distort should rearrange pixels on rich input."""
