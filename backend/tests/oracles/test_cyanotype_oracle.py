"""Auto-generated oracle for fx.cyanotype.
...
@pytest.mark.oracle
def test_cyanotype_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """cyanotype should visibly transform flat testsrc input."""
