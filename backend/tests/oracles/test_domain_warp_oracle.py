"""Auto-generated oracle for fx.domain_warp.
...
@pytest.mark.oracle
def test_domain_warp_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """domain_warp should rearrange pixels on rich input."""
