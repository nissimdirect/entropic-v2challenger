"""Auto-generated oracle for fx.cross_codec.
...
@pytest.mark.oracle
def test_cross_codec_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """cross_codec should produce visible change at default params."""
