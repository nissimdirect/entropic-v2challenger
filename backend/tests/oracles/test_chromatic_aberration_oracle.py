"""Auto-generated oracle for fx.chromatic_aberration.
...
@pytest.mark.oracle
def test_chromatic_aberration_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """chromatic_aberration should rearrange pixels on rich input."""
