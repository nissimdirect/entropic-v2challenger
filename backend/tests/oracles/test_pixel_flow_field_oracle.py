"""Auto-generated oracle for fx.pixel_flow_field.
...
@pytest.mark.oracle
def test_pixel_flow_field_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_flow_field should produce a detectable first-frame difference."""
