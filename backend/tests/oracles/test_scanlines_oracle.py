"""Auto-generated oracle for fx.scanlines.
...
@pytest.mark.oracle
def test_scanlines_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """scanlines should rearrange pixels on rich input."""
