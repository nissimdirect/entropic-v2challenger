"""Auto-generated oracle for fx.flow_distort.
...
MIN_L1 = 2.0  # default params give subtle displacement; catches silent-disable


@pytest.mark.oracle
def test_flow_distort_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """flow_distort should rearrange pixels on rich input."""
