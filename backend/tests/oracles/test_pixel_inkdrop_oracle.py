"""Auto-generated oracle for fx.pixel_inkdrop.
...
@pytest.mark.oracle
def test_pixel_inkdrop_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_inkdrop should produce a detectable first-frame difference."""
