"""Auto-generated oracle for fx.frame_drop.
...
@pytest.mark.oracle
def test_frame_drop_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """frame_drop should produce a detectable first-frame difference."""
