"""Auto-generated oracle for fx.dsp_phaser.
...
@pytest.mark.oracle
def test_dsp_phaser_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """dsp_phaser should produce a detectable first-frame difference."""
