"""Auto-generated oracle for fx.datamosh_real.
...
@pytest.mark.oracle
def test_datamosh_real_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """datamosh_real should produce visible change at default params."""
