"""Auto-generated oracle for fx.ring_mod.
...
@pytest.mark.oracle
def test_ring_mod_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """ring_mod should visibly transform flat testsrc input."""
