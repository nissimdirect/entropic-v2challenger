"""Auto-generated oracle for fx.beat_repeat.
...
@pytest.mark.oracle
def test_beat_repeat_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """beat_repeat should produce a detectable first-frame difference."""
