"""Auto-generated oracle for fx.channelshift.
...
@pytest.mark.oracle
def test_channelshift_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """channelshift should rearrange pixels on rich input."""
