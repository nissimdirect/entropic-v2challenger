"""Auto-generated oracle for fx.sharpen.
...
@pytest.mark.oracle
def test_sharpen_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """sharpen should alter high-frequency content."""
