"""Auto-generated oracle for fx.compression_oracle.
...
@pytest.mark.oracle
def test_compression_oracle_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """compression_oracle should produce visible change at default params."""
