"""Auto-generated oracle for fx.pixel_annihilate.
...
@pytest.mark.oracle
def test_pixel_annihilate_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """pixel_annihilate should produce visible change at default params."""
