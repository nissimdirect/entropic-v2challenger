"""Auto-generated oracle for fx.luma_key.
...
@pytest.mark.oracle
def test_luma_key_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """luma_key should produce visible change at default params."""
