"""Auto-generated oracle for fx.pixel_dimension_warp.
...
MIN_L1 = 2.0  # default params give subtle fold; catches silent-disable


@pytest.mark.oracle
def test_pixel_dimension_warp_permutes_pixels(
    mandelbrot_clip: Path, tmp_path: Path
) -> None:
    """pixel_dimension_warp should rearrange pixels on rich input."""
