"""Auto-generated oracle for fx.kaleidoscope.
...
@pytest.mark.oracle
def test_kaleidoscope_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """kaleidoscope should rearrange pixels on rich input."""
