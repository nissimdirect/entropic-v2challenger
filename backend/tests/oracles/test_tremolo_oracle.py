"""Auto-generated oracle for fx.tremolo.
...
@pytest.mark.oracle
def test_tremolo_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """tremolo should produce a detectable first-frame difference."""
