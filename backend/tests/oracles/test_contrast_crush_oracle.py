"""Auto-generated oracle for fx.contrast_crush.
...
@pytest.mark.oracle
def test_contrast_crush_changes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """contrast_crush is too subtle on flat testsrc — use mandelbrot's rich gradient."""
