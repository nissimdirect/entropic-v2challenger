"""Auto-generated oracle for fx.jpeg_artifacts.
...
@pytest.mark.oracle
def test_jpeg_artifacts_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """jpeg_artifacts should produce visible change at default params."""
