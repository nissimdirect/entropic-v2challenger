"""Auto-generated oracle for fx.pixel_melt.
...
@pytest.mark.oracle
def test_pixel_melt_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_melt should produce a detectable first-frame difference."""
