"""Auto-generated oracle for fx.chromatic_aberration_pro.
...
@pytest.mark.oracle
def test_chromatic_aberration_pro_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """chromatic_aberration_pro should rearrange pixels on rich input."""
