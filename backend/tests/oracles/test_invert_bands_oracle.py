"""Auto-generated oracle for fx.invert_bands.
...
@pytest.mark.oracle
def test_invert_bands_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """invert_bands should rearrange pixels on rich input."""
