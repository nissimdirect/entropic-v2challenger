"""Auto-generated oracle for fx.logistic_cascade.
...
@pytest.mark.oracle
def test_logistic_cascade_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """logistic_cascade should visibly transform flat testsrc input."""
