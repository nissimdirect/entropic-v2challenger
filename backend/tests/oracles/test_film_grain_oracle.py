"""Auto-generated oracle for fx.film_grain.
...
@pytest.mark.oracle
def test_film_grain_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """film_grain should produce visible change at default params."""
