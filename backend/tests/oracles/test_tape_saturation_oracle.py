"""Auto-generated oracle for fx.tape_saturation.
...
@pytest.mark.oracle
def test_tape_saturation_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """tape_saturation should visibly transform flat testsrc input."""
