"""Auto-generated oracle for fx.byte_corrupt.
...
@pytest.mark.oracle
def test_byte_corrupt_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """byte_corrupt should produce visible change at default params."""
