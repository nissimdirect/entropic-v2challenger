"""Auto-generated oracle for fx.dsp_flange.
...
@pytest.mark.oracle
def test_dsp_flange_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """dsp_flange should produce a detectable first-frame difference."""
