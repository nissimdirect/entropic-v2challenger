"""Auto-generated oracle for fx.film_grain_warm.
...
@pytest.mark.oracle
def test_film_grain_warm_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """film_grain_warm should produce visible change at default params."""
