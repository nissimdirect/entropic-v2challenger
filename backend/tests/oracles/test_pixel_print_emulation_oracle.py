"""Auto-generated oracle for fx.pixel_print_emulation.
...
@pytest.mark.oracle
def test_pixel_print_emulation_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """pixel_print_emulation should produce visible change at default params."""
