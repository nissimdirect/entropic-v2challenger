"""Auto-generated oracle for fx.saturation_warp.
...
@pytest.mark.oracle
def test_saturation_warp_changes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """saturation_warp is too subtle on flat testsrc — use mandelbrot's rich gradient."""
