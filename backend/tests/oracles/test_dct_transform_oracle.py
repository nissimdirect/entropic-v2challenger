"""Auto-generated oracle for fx.dct_transform.
...
@pytest.mark.oracle
def test_dct_transform_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """dct_transform should alter high-frequency content."""
