"""Auto-generated oracle for fx.infrared.
...
@pytest.mark.oracle
def test_infrared_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """infrared should visibly transform flat testsrc input."""
