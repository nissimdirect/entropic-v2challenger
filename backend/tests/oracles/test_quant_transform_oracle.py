"""Auto-generated oracle for fx.quant_transform.
...
@pytest.mark.oracle
def test_quant_transform_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """quant_transform should produce visible change at default params."""
