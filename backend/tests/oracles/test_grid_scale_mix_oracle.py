"""Auto-generated oracle for fx.grid_scale_mix.
...
@pytest.mark.oracle
def test_grid_scale_mix_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """grid_scale_mix should produce visible change at default params."""
