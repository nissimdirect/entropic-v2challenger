"""Auto-generated oracle for fx.hue_shift.
...
@pytest.mark.oracle
def test_hue_shift_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """hue_shift should visibly transform flat testsrc input."""
