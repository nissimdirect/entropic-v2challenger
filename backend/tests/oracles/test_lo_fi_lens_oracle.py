"""Auto-generated oracle for fx.lo_fi_lens.
...
@pytest.mark.oracle
def test_lo_fi_lens_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """lo_fi_lens should produce visible change at default params."""
