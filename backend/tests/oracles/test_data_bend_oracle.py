"""Auto-generated oracle for fx.data_bend.
...
@pytest.mark.oracle
def test_data_bend_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """data_bend should produce visible change at default params."""
