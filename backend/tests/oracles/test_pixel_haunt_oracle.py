"""Auto-generated oracle for fx.pixel_haunt.
...
@pytest.mark.oracle
def test_pixel_haunt_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_haunt should produce a detectable first-frame difference."""
