"""Auto-generated oracle for fx.edge_detect.
...
@pytest.mark.oracle
def test_edge_detect_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """edge_detect should alter high-frequency content."""
