"""Auto-generated oracle for fx.soft_bloom.
...
@pytest.mark.oracle
def test_soft_bloom_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """soft_bloom should alter high-frequency content."""
