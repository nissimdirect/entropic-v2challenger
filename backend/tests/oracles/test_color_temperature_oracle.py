"""Auto-generated oracle for fx.color_temperature.
...
@pytest.mark.oracle
def test_color_temperature_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """color_temperature should visibly transform flat testsrc input."""
