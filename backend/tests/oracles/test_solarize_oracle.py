"""Auto-generated oracle for fx.solarize.
...
@pytest.mark.oracle
def test_solarize_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """solarize should visibly transform flat testsrc input."""
