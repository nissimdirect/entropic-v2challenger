"""Auto-generated oracle for fx.afterimage.
...
@pytest.mark.oracle
def test_afterimage_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """afterimage should produce a detectable first-frame difference."""
