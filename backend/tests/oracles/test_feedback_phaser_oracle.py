"""Auto-generated oracle for fx.feedback_phaser.
...
@pytest.mark.oracle
def test_feedback_phaser_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """feedback_phaser should produce a detectable first-frame difference."""
