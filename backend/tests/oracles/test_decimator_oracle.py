"""Auto-generated oracle for fx.decimator.
...
@pytest.mark.oracle
def test_decimator_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """decimator should produce a detectable first-frame difference."""
