"""Auto-generated oracle for fx.pixel_superfluid.
...
@pytest.mark.oracle
def test_pixel_superfluid_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_superfluid should produce a detectable first-frame difference."""
