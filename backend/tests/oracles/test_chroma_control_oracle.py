"""Auto-generated oracle for fx.chroma_control.
...
MIN_L1 = 2.0
MIN_LAPLACIAN_RATIO_CHANGE = 0.02  # 2% — chroma subsample is subtle at default


@pytest.mark.oracle
def test_chroma_control_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """chroma_control should alter high-frequency content."""
