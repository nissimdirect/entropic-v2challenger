"""Auto-generated oracle for fx.noise.
...
@pytest.mark.oracle
def test_noise_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """noise should produce visible change at default params."""
