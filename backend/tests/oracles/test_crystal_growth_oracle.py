"""Auto-generated oracle for fx.crystal_growth.
...
@pytest.mark.oracle
def test_crystal_growth_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """crystal_growth should add visible content to the frame."""
