"""Auto-generated oracle for fx.sparkle.
...
@pytest.mark.oracle
def test_sparkle_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """sparkle should add visible content to the frame."""
