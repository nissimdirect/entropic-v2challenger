"""Auto-generated oracle for fx.glitch_repeat.
...
@pytest.mark.oracle
def test_glitch_repeat_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """glitch_repeat should rearrange pixels on rich input."""
