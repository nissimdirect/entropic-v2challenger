"""Auto-generated oracle for fx.reaction_diffusion.
...
@pytest.mark.oracle
def test_reaction_diffusion_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """reaction_diffusion should add visible content to the frame."""
