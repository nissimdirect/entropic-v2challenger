"""Auto-generated oracle for fx.erosion_sim.
...
@pytest.mark.oracle
def test_erosion_sim_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """erosion_sim should produce a detectable first-frame difference."""
