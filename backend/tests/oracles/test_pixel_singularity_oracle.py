"""Auto-generated oracle for fx.pixel_singularity.
...
@pytest.mark.oracle
def test_pixel_singularity_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """pixel_singularity should produce a detectable first-frame difference."""
