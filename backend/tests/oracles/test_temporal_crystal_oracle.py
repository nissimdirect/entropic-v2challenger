"""Auto-generated oracle for fx.temporal_crystal.
...
@pytest.mark.oracle
def test_temporal_crystal_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """temporal_crystal should produce a detectable first-frame difference."""
