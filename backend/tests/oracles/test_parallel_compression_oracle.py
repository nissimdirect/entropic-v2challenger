"""Auto-generated oracle for fx.parallel_compression.
...
@pytest.mark.oracle
def test_parallel_compression_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """parallel_compression should visibly transform flat testsrc input."""
