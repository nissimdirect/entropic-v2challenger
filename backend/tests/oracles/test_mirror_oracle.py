"""Auto-generated oracle for fx.mirror.
...
@pytest.mark.oracle
def test_mirror_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """mirror should rearrange pixels on rich input."""
