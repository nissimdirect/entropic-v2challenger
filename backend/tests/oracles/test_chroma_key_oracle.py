"""Auto-generated oracle for fx.chroma_key.
...
@pytest.mark.oracle
def test_chroma_key_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """chroma_key should produce visible change at default params."""
