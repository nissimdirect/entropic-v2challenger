"""Auto-generated oracle for fx.ascii_art.
...
@pytest.mark.oracle
def test_ascii_art_rerenders_structure(testsrc_clip: Path, tmp_path: Path) -> None:
    """ascii_art should dramatically restructure output."""
