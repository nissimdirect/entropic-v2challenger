"""Auto-generated oracle for fx.block_crystallize.
...
@pytest.mark.oracle
def test_block_crystallize_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """block_crystallize should alter high-frequency content."""
