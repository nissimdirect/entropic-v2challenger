"""Auto-generated oracle for fx.contour_lines.
...
@pytest.mark.oracle
def test_contour_lines_rerenders_structure(testsrc_clip: Path, tmp_path: Path) -> None:
    """contour_lines should dramatically restructure output."""
