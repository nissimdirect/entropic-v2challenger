"""Auto-generated oracle for fx.row_shift.
...
@pytest.mark.oracle
def test_row_shift_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """row_shift should rearrange pixels on rich input."""
