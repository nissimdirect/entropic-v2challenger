"""Auto-generated oracle for fx.lens_distortion.
...
@pytest.mark.oracle
def test_lens_distortion_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """lens_distortion should rearrange pixels on rich input."""
