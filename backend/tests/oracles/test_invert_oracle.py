"""Auto-generated oracle for fx.invert.
...
@pytest.mark.oracle
def test_invert_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """invert should visibly transform flat testsrc input."""
