"""Auto-generated oracle for fx.histogram_eq.
...
@pytest.mark.oracle
def test_histogram_eq_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """histogram_eq should alter high-frequency content."""
