"""Auto-generated oracle for fx.surveillance_sim.
...
@pytest.mark.oracle
def test_surveillance_sim_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """surveillance_sim should produce visible change at default params."""
