"""Auto-generated oracle for fx.brightness_exposure.
...
@pytest.mark.oracle
def test_brightness_exposure_changes_pixels(testsrc_clip: Path, tmp_path: Path) -> None:
    """brightness_exposure should visibly transform flat testsrc input."""
