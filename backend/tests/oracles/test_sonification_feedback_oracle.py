"""Auto-generated oracle for fx.sonification_feedback.
...
@pytest.mark.oracle
def test_sonification_feedback_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """sonification_feedback should produce a detectable first-frame difference."""
