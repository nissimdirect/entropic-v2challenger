"""Auto-generated oracle for fx.generation_loss.
...
@pytest.mark.oracle
def test_generation_loss_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """generation_loss should produce visible change at default params."""
