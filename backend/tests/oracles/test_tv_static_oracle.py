"""Auto-generated oracle for fx.tv_static.
...
@pytest.mark.oracle
def test_tv_static_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """tv_static should produce visible change at default params."""
