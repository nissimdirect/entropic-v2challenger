"""Auto-generated oracle for fx.median_filter.
...
@pytest.mark.oracle
def test_median_filter_alters_sharpness(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """median_filter should alter high-frequency content."""
