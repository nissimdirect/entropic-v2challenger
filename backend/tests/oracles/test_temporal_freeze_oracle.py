"""Auto-generated oracle for fx.temporal_freeze.
...
@pytest.mark.oracle
def test_temporal_freeze_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """temporal_freeze should produce a detectable first-frame difference."""
