"""Auto-generated oracle for fx.medical_imaging.
...
@pytest.mark.oracle
def test_medical_imaging_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """medical_imaging should produce visible change at default params."""
