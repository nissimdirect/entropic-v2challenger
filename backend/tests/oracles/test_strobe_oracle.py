"""Auto-generated oracle for fx.strobe.
...
@pytest.mark.oracle
def test_strobe_changes_output(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """strobe should produce a detectable first-frame difference."""
