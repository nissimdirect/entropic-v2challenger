"""Auto-generated oracle for fx.block_corrupt.
...
@pytest.mark.oracle
def test_block_corrupt_permutes_pixels(mandelbrot_clip: Path, tmp_path: Path) -> None:
    """block_corrupt should rearrange pixels on rich input."""
