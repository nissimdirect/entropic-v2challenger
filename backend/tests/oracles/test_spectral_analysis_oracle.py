"""Auto-generated oracle for fx.spectral_analysis.
...
@pytest.mark.oracle
def test_spectral_analysis_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """spectral_analysis should produce visible change at default params."""
