"""Auto-generated oracle for fx.entropy_map.
...
@pytest.mark.oracle
def test_entropy_map_produces_output(testsrc_clip: Path, tmp_path: Path) -> None:
    """entropy_map should produce visible change at default params."""
