/**
 * W1.5b PK.A2/A3 — pure grid-math oracle for utils/quantize-grid.ts.
 */
import { describe, it, expect } from 'vitest'
import { selectQuantizeGridLevel, formatQuantizeReadout, QUANT_LABELS } from '../../renderer/utils/quantize-grid'
