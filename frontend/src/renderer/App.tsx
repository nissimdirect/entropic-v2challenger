...
function AppInner() {
  ...
  // F4b PR2: subscription + handler switch extracted to renderer/app/menuActions.ts
  // (useMenuActions) — byte-identical behavior, see that file's header comment.
  useMenuActions({
    handleImportMedia,
    handleAddTextTrack,
    handleNewProject,
    handleProjectHydrated,
